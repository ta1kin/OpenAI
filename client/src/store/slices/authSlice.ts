...
const initialState: AuthState = {
    ...
    email: '',
    password: '',
    accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImlhdCI6MTczMjU0OTY5MSwiZXhwIjoxNzMyNjM2MDkxfQ.Hq8nL1L6QAccj_4Rxtl3KmaGDYjTXdZAWzOMWoFM29g',
    resetToken: '',
    saveMe: false,
    code: '',
    role: '',
